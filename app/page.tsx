...
export default function Home() {
  return (
    <div className="relative flex flex-col w-full min-h-screen bg-gradient-to-br from-rose-200 via-pink-100 to-sky-200 text-gray-900 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-white/20 backdrop-blur-sm pointer-events-none -z-10" />
